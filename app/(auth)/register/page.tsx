    ...
    <div className="w-full max-w-lg relative">
      ...
      >
        <div className="relative z-10 flex flex-col items-center text-center mb-10">
          ...
          <p className="text-sm font-medium text-gray-500 mt-2">Join AWH TECH and launch your remote career</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative group">
              ...
              <input id="full_name" type="text" {...register('full_name')} placeholder="Muhammad Bin Qasim" className={`w-full rounded-xl border border-gray-200 bg-gray-50/50 py-4 pl-12 pr-4 text-sm font-medium outline-none transition-all focus:border-primary-500 focus:bg-white focus:ring-4 focus:ring-primary-500/10 ${errors.full_name ? 'border-red-200 bg-red-50/30' : ''}`} />
            </div>
        ...
        <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]"><span className="bg-white/80 backdrop-blur-sm px-4">Social Connect</span></div>
        </div>
